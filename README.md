## TIER IV universe / split mirror (evaluator)

This repository split mirrors the evaluator subtrees of several upstream repositories, used for TIER IV release workflows.
...
| Branch | Contents |
| --- | --- |
| `awf-latest` | `autowarefoundation/autoware_universe:main`, `evaluator/` |
